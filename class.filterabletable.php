...
require_once 'classes/class.sortabletable.php';
...
class FilterableTable extends SortableTable {
    ...
    protected function printScript() {
        ...
        <script>
        {
            ...
            var filters = document.getElementById("tableFilters<?php echo $this->id; ?>");
...
class FilterableParam {
    ...
    public function __construct($column, $type, $name, $default = "", $params = array()) {
        ...
        switch ($type) {
            case TEXT_FIELD:
                if (!is_array($this->column)) $this->column = array($this->column);
                break;
            case CHECK_BOX:
